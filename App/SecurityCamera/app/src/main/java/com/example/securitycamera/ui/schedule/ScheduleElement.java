...
public class ScheduleElement extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_schedule_element, container, false);
        ...
        scheduleAlarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                scheduleAlarm();
                Navigation.findNavController(v).navigate(R.id.action_createAlarmFragment_to_navigation_schedule);
            }
        });
